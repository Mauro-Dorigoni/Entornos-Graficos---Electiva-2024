        ...
        <form method="post" action="<?php echo backendHTTPLayer . '/updateShop.http.php'; ?>" enctype="multipart/form-data">
              ...
              <div class="form-row mb-4">
                  <div class="col-md-4 mb-3">
                    ...
                    <!-- DUDA: Le dejamos editar el ID del dueño o solo el correo. Porque sino debemos verificar que sea existente... -->
                  </div>
                  <div class="col-md-8">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control <?= $soloLectura='' ?"form-control-locked" : ''?>" value="<?= htmlspecialchars($shop->getOwner()->getEmail()) ?>" <?=$soloLectura ?>>
                    </div>
                  </div>
              </div>
            ...
            <hr class="my-4">
              ...
              <div class="form-row mb-4">
                  ...
                  <div class="col-md-8">
                     ...
                     <div class="input-group">
                        ...
                        <input type="text" class="form-control <?= $soloLectura='' ?"form-control-locked" : ''?>" value="<?= htmlspecialchars($shop->getLocation()) ?>" <?=$soloLectura ?>>
                     </div>
                  </div>
              </div>
              ...
              <div class="form-group mb-4">
                ...
                <input type="text" name="name" class="form-control form-control-modern" value="<?= htmlspecialchars($shop->getName()) ?>" required>
              </div>
              ...
              <div class="form-group mb-4">
                ...
                <textarea name="description" class="form-control form-control-modern" rows="4"><?= htmlspecialchars($shop->getDescription() ?? '') ?></textarea>
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
              ...
              <div class="d-flex justify-content-end mt-5">
                  <a href="listaLocales.php" class="btn btn-light btn-lg mr-3 text-muted">Cancelar</a>
