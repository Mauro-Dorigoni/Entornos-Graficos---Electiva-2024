...
if (!isset($_SESSION['token']) || !isset($_SESSION['action']) || $_SESSION["action"]!="recovery"){
                ...
                <div class="card" style="border-radius: 1rem; background-color: #eae8e0">
                    ...
                    <div class="col-md-6 col-lg-5 d-none d-md-flex justify-content-center align-items-center" style="background-color: white; border-radius: 1rem 0 0 1rem;">
                        <img src="../assets/LogoPromoShopFondoBlanco.png"
                            alt="password change form" class="img-fluid" style="max-width: 80%; height: auto;" />
                    </div>
                        ...
                        <div class="card-body p-4 p-lg-5 text-black">
                            <form action=<?php echo backendHTTPLayer."/passChange.http.php"?> method="post" onsubmit="return validatePasswords()">
                                ...
                                <div class="pt-1 mb-4">
                                    <button type="submit" class="btn btn-lg btn-block btn-outline-orange">Aceptar</button>
                                </div>
                            </form>
                        </div>
                    </div>
