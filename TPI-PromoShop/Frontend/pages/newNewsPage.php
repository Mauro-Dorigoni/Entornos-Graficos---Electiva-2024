...
<div class="container-fluid my-5" id="center-container">
    <div class="card card-custom" id="card-custom">
        <div class="card-body p-4 p-lg-5 text-black">
            <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Alta de Novedad</h5>
            <hr>
            <form method="post" action="<?php echo backendHTTPLayer . '/newNews.http.php'; ?>" enctype="multipart/form-data">
                <div class="form-outline mb-4">
                    ...
                    <textarea name="newsText" class="form-control form-control-lg" rows="4" required></textarea>
                </div>
                <hr>
                <div class="row">
                    ...
                    <div class="col-md-6 form-outline mb-4">
                        <label>
                            <i class="far fa-calendar-times mr-2"></i> Vigencia hasta (opcional)
                        </label>
                        <input type="date" name="dateTo" class="form-control form-control-lg">
                    </div>
                </div>
                <hr>
                <div class="form-outline mb-4">
                    <label>
                        <i class="fas fa-image mr-2"></i> Imagen destacada
                    </label>
