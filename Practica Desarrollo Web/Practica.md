# Práctica Número 3: Desarrollo Web
## Parte 1
...
**16-** Al verificar las funcionalidades y aplicaciones que ofrece un sitio web, hay varios chequeos esenciales que se pueden realizarse de manera de asegurar que el sitio sea funcional, eficiente y brinde una buena experiencia de usuario.
        ...
        - Interacción del usuario: Asegura que las interacciones del usuario con el sitio (como hacer clic o desplazarse) se procesen correctamente y reciban retroalimentación visual clara.
        ...
        - Validación de datos: Asegura que los datos ingresados por los usuarios sean validados adecuadamente para evitar errores.
